---
description: Writes and runs tests for a specific Spendly feature. Pass the spec name as argument e.g. /test-feature 05-backend-for-profile-page
...
<spec-name> e.g. /test-feature 05-backend-for-profile-page"
