---
description: Runs parallel security and quality code review for a specific Spendly feature. Pass the spec 
...
De-duplicate any overlapping findings — if both agents flagged the same line for different reasons, merge them into one finding with both perspectives noted.
